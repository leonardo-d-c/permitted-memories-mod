...
var fusion_friends = {
			...
			"illusion" : ["fiend", "spellcaster", "winged beast"],
			...
			"pyro" : ["aqua", "beast", "dragon", "insect", "warrior", "winged beast", "wyrm", "zombie"],
			"reptile" : ["aqua", "beast-warrior", "beast", "fiend", "warrior",],
			"rock" : ["dinosaur", "dragon", "insect", "warrior", "wyrm", "zombie"],
			"sea serpent" : ["aqua", "dinosaur", "dragon", "winged beast", "wyrm"],
			"spellcaster" : ["fairy", "fiend", "illusion", "machine", "psychic", "thunder", "zombie"],
			"thunder" : ["aqua", "beast", "dragon", "machine", "psychic", "spellcaster", "wyrm", "zombie"],
			"warrior" : ["beast", "dragon", "fairy", "fiend", "fish", "insect", "machine", "plant", "psychic", "pyro", "reptile", "rock", "wyrm", "zombie"],
			"winged beast": ["aqua", "beast-warrior", "beast", "fairy", "fiend", "illusion", "pyro", "sea serpent"],
			"wyrm": ["aqua", "fairy", "fiend", "machine", "plant", "pyro", "rock", "sea serpent", "thunder", "warrior", "zombie"],
	...
	#WITH EFFECT: The description will be base on what kind of effect the card has
		...
		#Anything else will be a Monster Effect
			...
			match card_on_CardList.effect[0]:
				...
				"on_summon":
					match card_on_CardList.effect[1]:
						"air_neos", "castle_power_up", "copy_atk", "cyber_stein", "equip_boost", "flip_enemy_down", "gandora", "stop_defense", "summon_pharaoh", "super_robo", "white_horned", "wicked_avatar", "wicked_dreadroot", "wicked_eraser", "halve_opp_LP", "dhero_plasma", "ignore_effects": #looks for it's own identifier in the language list
