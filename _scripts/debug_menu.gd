...
func _on_change_card_id_button_up():
	...
	get_node("../player_hand/card_2").update_card_information("00496")
	get_node("../player_hand/card_3").update_card_information("01738")
	get_node("../player_hand/card_4").update_card_information("01816")
